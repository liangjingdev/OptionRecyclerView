 ...
 * <p>
 * function:ListView和GridView通用的适配器
 */

public abstract class AdapterForAbsListView<T> extends BaseAdapter {
    ...
    public AdapterForAbsListView(Context context, List<T> data, int defaultLayoutId) {
        mContext = context;
        mData = data;
        mDefaultLayouId = defaultLayoutId;
    }
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        //得到item对应的ViewHolder
        ViewHolderForAbsListView viewHolder = getViewHolder(position, convertView, viewGroup);
     ...
     * 对item进行数据设置（交给开发人员）
     */
    public abstract void convert(ViewHolderForAbsListView helper, T item, int position);
     ...
     * 得到item对应的ViewHolder
     */
    private ViewHolderForAbsListView getViewHolder(int position, View convertView, ViewGroup viewGroup) {
        ViewHolderForAbsListView holder = ViewHolderForAbsListView.get(mContext, mDefaultLayouId, position, convertView, viewGroup);
